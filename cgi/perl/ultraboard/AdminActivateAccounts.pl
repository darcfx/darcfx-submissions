...
sub ActivateAccounts {
	...
	$HTML.=	&Table($TableWidth,$TableAlign,"","6","","").
                ...
                &Tr("","","").
					&Td("","","","","","","nowrap","","").
						...
						&HiddenBox("Action","DoActivateAccounts").
				...
				&Tr("","",$HeaderBGColor).
					&Td("","","6","","","","","","").
						&Font($FontFace,$HeaderTextSize,$HeaderTextColor).
							"<b>ACTIVATE/DISACTIVATE MEMBERS ACCOUNT</b>".
						"</font>".
					"</td>".
				"</tr>".
				&Tr("","",$CategoryBGColor).
	...
	$HTML.=		&Tr("","",$CategoryBGColor).
					&Td("","","6","","","","","","").
						"<center>".&Submit("","ACTIVATE/DISACTIVATE THESE MEMBERS ACCOUNT","width:$IETextBoxSize")."</center>".
					"</td>".
				"</tr>".
				&Tr("","",$MenuBGColor).
					&Td("","","6","","","","","","").
	...
	($HTML.=<<'			HTML')=~s/^\s+//gm;
			...
			HTML
	&PrintTheme("$UBName Administrative Center - Activate/Disactivate Members Account",$HTML);
	exit;
}
###############################################################################
1;# End of ActivateAccounts Function
###############################################################################