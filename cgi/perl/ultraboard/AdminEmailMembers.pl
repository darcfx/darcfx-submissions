...
sub EmailMembers {
	...
	$HTML.=	&Table($TableWidth,$TableAlign,"","6","","").
                ...
                &Tr("","","").
					&Td("","","","","","","nowrap","","").
						...
						&HiddenBox("Action","DoEmailMembers").
	...
	for ($i=0;$i<=$#SortedList;$i++) {
		...
		$HTML.=	&Tr("","",$RowColor).
					&Td("20","","","","CENTER","","",$ColumnOddBGColor,"").
						&Checkbox("MemberID_$i",$MemberInfo[0].$Spliter.$MemberInfo[3],"","").
					"</td>".
	...
	$HTML.=		&Tr("","",$CategoryBGColor).
				...
				&Tr("","",$RowOddBGColor).
					&Td("","","6","","","","",$ColumnOddBGColor,"").
						&TextBox("Subject","",$TextBoxSize,"","width:$IETextBoxSize").			
					"</td>".
				"</tr>".
				&Tr("","",$CategoryBGColor).
					&Td("","","6","","","","","","").
				...
				&Tr("","",$RowOddBGColor).
					&Td("","","6","","","","",$ColumnOddBGColor,"").
						&TextArea("Message","",$TextBoxSize,"10","VIRUAL","width:$IETextBoxSize").	
					"</td>".
				"</tr>".
				&Tr("","",$CategoryBGColor).
					&Td("","","6","","","","","","").
						"<center>".&Submit("","SEND EMAIL TO THESE MEMBERS","width:$IETextBoxSize")."</center>".
					"</td>".
				"</tr>".
				&Tr("","",$MenuBGColor).
					&Td("","","6","","","","","","").
	...
	($HTML.=<<'			HTML')=~s/^\s+//gm;
			...
			HTML
	&PrintTheme("$UBName Administrative Center - Email to Members",$HTML);
	exit;
}
###############################################################################
1;# End of EmailMembers Function
###############################################################################