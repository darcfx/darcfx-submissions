...
###############################################################################
sub DoModifyBoard {
	&ShowError("MODIFYING PROBLEM","You forgot to select which board to modify.") if (!$in{'BoardID'});
###############################################################################
	...
	$AllGroupsRead="on";
	$AllGroupsPost="";
	if ($BoardInfo[6] eq "Public") {
		$AllGroupsRead="on";
		$AllGroupsPost="on";
	}elsif ($BoardInfo[6] eq "Private") {
		require "$DBPath/$in{'BoardID'}/Access.db";
		$AllGroupsRead="";
	}
###############################################################################
	$HTML.=	&Table($TableWidth,$TableAlign,"","6","","").
                ...
                &Tr("","","").
					&Td("","","","","","","nowrap","","").
						...
						&HiddenBox("Action","DoModifyBoard2").
						&HiddenBox("BoardID",$in{'BoardID'}).
			...
			&BTable($TableWidth,$TableAlign,"0","0",$TableCellSpacing,$TableCellPadding,$TableBorderColor,"","").
				&Tr("","",$HeaderBGColor).
					&Td("","","4","","","","","","").
						&Font($FontFace,$HeaderTextSize,$HeaderTextColor).
							"<b>MODIFY BOARD (".uc($BoardInfo[0]).")</b>".
						"</font>".
					"</td>".
				"</tr>".
                &Tr("","",$CategoryBGColor).
				...
				&Tr("","",$RowOddBGColor).
					&Td("","","4","","","","","","").
						&TextBox("BoardName",$BoardInfo[1],$TextBoxSize,"","width:$IETextBoxSize").
					"</td>".
				"</tr>".
				&Tr("","",$CategoryBGColor).
					&Td("","","4","","","","","","").
				...
				&Tr("","",$RowOddBGColor).
					&Td("","","4","","","","","","").
						&Select("BoardModerators","","width:$IETextBoxSize","","$BoardInfo[4]",
							"No Moderator","",
							@ModeratorsGroup
						).
					"</td>".
				...
				&Tr("","",$RowOddBGColor).
					&Td("","","4","","","","","","").
						&Select("BoardCategory","","width:$IETextBoxSize","","$BoardInfo[3]",
							@Categories
						).
					"</td>".
				"</tr>".
				...
				&Tr("","",$RowOddBGColor).
					&Td("","","4","","","","","","").
						&TextBox("BoardDescription",$BoardInfo[2],$TextBoxSize,"","width:$IETextBoxSize").
					"</td>".
				"</tr>".
				&Tr("","",$CategoryBGColor).
					&Td("","","4","","","","","","").
				...
				&Tr("","",$RowOddBGColor).
					&Td("","","4","","","","","","").
						&Select("BoardStatus","","width:$IETextBoxSize","","$BoardInfo[5]",
							"Active","Active",
							"Inactive","Inactive"
						).
					"</td>".
				...
				&Tr("","",$RowColor).
					&Td("70","","","","CENTER","","",$ColumnOddBGColor,"").
						&Checkbox("AllGroupsRead","on","","$AllGroupsRead","onClick=\"CheckAllRead()\"").
					"</td>".
					&Td("70","","","","CENTER","","",$ColumnEvenBGColor,"").
						&Checkbox("AllGroupsPost","on","","$AllGroupsPost","onClick=\"CheckAllPost()\"").
					"</td>".
	...
	for ($i=0;$i<=$#GROUPS_DATA;$i++) {
		...
		if ($GroupInfo[0] ne "administrator") {
			...
			$ReadGroup="";
			$PostGroup="";
			if (($Access{$GroupInfo[0]} eq "FullAccess")||($BoardInfo[6] eq "Public")||($BoardInfo[6] eq "Protected")) {
				$ReadGroup=$GroupInfo[0];
				$PostGroup=$GroupInfo[0];
			}elsif ($Access{$GroupInfo[0]} eq "ReadOnly"){
				$ReadGroup=$GroupInfo[0];
				$PostGroup="";
			}
			$HTML.=	&Tr("","",$RowColor).
						&Td("70","","","","CENTER","","",$ColumnOddBGColor,"").
							&Checkbox("ReadGroupID_$i","$GroupInfo[0]","",$ReadGroup,"onClick=\"UnAllGroups('$i','Read')\"").
						"</td>".
						&Td("70","","","","CENTER","","",$ColumnEvenBGColor,"").
							&Checkbox("PostGroupID_$i","$GroupInfo[0]","",$PostGroup,"onClick=\"UnAllGroups('$i','Post')\"").
						"</td>".
						&Td("80%","","","","","","",$ColumnOddBGColor,"").
							&Font($FontFace,$TextSize,$TextColor).
...
###############################################################################
1;# End of DoModifyBoard Function
###############################################################################