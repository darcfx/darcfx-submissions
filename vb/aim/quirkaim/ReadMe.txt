...
¯¯¯¯¯¯ AOL Instant Messenger Version 2.0 [AIM].  It does all of the basic
       functions a user does on AIM.

Functions:  
¯¯¯¯¯¯¯¯¯¯
AboutBox 		[Shows my about box]
AddBuddList		[Adds the BuddyList to a ListBox or ComboBox]
